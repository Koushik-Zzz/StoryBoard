import {
  ...
  TLShapePartial,
  createShapeId,
  // toRichText, // Uncomment when restoring promotional content
} from "tldraw";
...
// Commented out for clean storyboard - uncomment to restore promotional content
/*
type TextOptions = {
...
export function seedDefaultStoryboard(editor: Editor, frameId?: TLShapeId | null) {
  if (!frameId) return;
  ...
  addText("StoryBoard", leftColumnX, topY - 60, { size: "xl" }, 2);
  addText(
  ...
  addText(`The StoryBoard Team 🚀`, -800, -100, { size: "l", font: "mono" });
  */
