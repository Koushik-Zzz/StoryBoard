            ...
            <div className="max-w-md mx-auto w-full">
              ...
              <div className="bg-white/60 backdrop-blur-md border border-gray-200/50 rounded-2xl p-8 shadow-xl shadow-black/5">
                <div className="text-center mb-8">
                  <div className="inline-flex p-4 bg-[#FFD700]/10 rounded-2xl mb-4">
                    <LogIn className="w-8 h-8 text-[#FFD700]" />
                  </div>
                  <h1 className="text-4xl font-bold text-gray-900 mb-2 font-bentani">
                    Welcome Back
                  </h1>
                  <p className="text-gray-600 font-light">
                    Sign in to continue to <span className="font-orbitron text-[#FFD700]">StoryBoard</span>
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full py-3 bg-white border-2 border-gray-200 text-gray-700 font-semibold rounded-xl hover:bg-gray-50 transition-all duration-200 flex items-center justify-center gap-3 shadow-lg shadow-black/5 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                  >
